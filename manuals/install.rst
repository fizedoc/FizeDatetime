...
FizeDatetime 的环境要求如下：

-  "php": ">=5.4.0"
-  如果使用 Calendar ，请开启 calendar 扩展

使用Composer安装
================

FizeDatetime 支持使用 `Composer <https://www.phpcomposer.com/>`_ 安装，也是唯一官方推荐的安装方法。
...
.. code-block:: bash
  ...
  composer require fize/datetime
  
好了！一步到位，您现在可以开始使用 FizeDatetime 了，就是这么简单！~
